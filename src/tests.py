...
result_a = [4.01e+02, 6.60e+00, 1.09e+02, -1.12e+02, 6.54e+01, 1.21e+02, 1.16e+02, 2.88e+01]

def test_results():
    print(f'Testing on Array: ', end='')
    y_a = utils.dct(test_m[0])
    ret = np.allclose(result_a, y_a, rtol=0.01)
    print(f'{ret}')

    print(f'Testing on Matrix: ', end='')
    y_m = utils.dct2(test_m)
